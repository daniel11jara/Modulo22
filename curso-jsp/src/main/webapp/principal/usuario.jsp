                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                      ...
                                                      <form class="form-material" action = "<%= request.getContextPath()%>/ServeletUsusarioController" method="post" id = "formUser">
												...
												<tbody>
													<c:forEach items = "${modelLogins}" var = "ml">
														<tr>
															...
															<td><a class="btn btn-success" href="<%=request.getContextPath() %>/ServeletUsusarioController?acao=buscarEditar&id=${ml.id}">Ver</a></td>
														</tr>
